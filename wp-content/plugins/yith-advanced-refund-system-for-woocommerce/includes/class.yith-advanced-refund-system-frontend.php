    ...
    class YITH_Advanced_Refund_System_Frontend {
        ...
        public function enqueue_scripts() {
	        ...
	        if ( version_compare( WC()->version, '2.7.0', '>=' ) ) {
		        wp_enqueue_style( 'ywraq_prettyPhoto_css', YITH_WCARS_ASSETS_URL . '/css/prettyPhoto.css' );
		        wp_enqueue_script( 'ywraq-prettyPhoto', YITH_WCARS_ASSETS_JS_URL . '/jquery.prettyPhoto' . $suffix . '.js', array( 'jquery' ), false, true );
	        }else{
